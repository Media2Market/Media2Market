...
// Vercel's default function timeout is 10 seconds. Fluid Compute (enabled on
// this project) raises the Hobby-plan ceiling to 300 seconds — 290 sits as
// close to that hard ceiling as is safely possible. Combined with the
// reduced scope below (2 statements, fewer search calls), this should give
// real reliability rather than continuing to just raise a number.
export const config = {
  maxDuration: 290
};
