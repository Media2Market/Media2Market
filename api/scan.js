...
// Vercel's default function timeout is 10 seconds, and even the extended
// 60-second cap without Fluid Compute wasn't enough for multi-statement
// research. With Fluid Compute enabled on the project (Settings > Functions),
// Hobby plans get up to 300 seconds — 180 gives generous headroom without
// pushing all the way to that ceiling.
export const config = {
  maxDuration: 180
};
